...
private_ip=$(cat $cluster_config | y2j | jq -r .ipsec_partner.private.ip)
private_ip_cidr_netmask=$(cat $cluster_config | y2j | jq -r .ipsec_partner.private.cidr_netmask)
private_ip_nic=$(cat $cluster_config | y2j | jq -r .ipsec_partner.private.nic)
private_ip_vnic_no=$(cat $cluster_config | y2j | jq -r .ipsec_partner.private.vnic_no)
